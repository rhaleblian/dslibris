...
static void __libc_lock_init(_LOCK_T *lock) {
        *lock = __LOCK_INITIALIZER;
}

static void __libc_lock_close(_LOCK_T *lock ) {}

static void __libc_lock_init_recursive(_LOCK_RECURSIVE_T *lock) {
        *lock = __LOCK_INITIALIZER_RECURSIVE;
}

static void __libc_lock_close_recursive(_LOCK_RECURSIVE_T *lock ) {}
...
/* Returns errno */
static int __libc_cond_init(_COND_T *cond) {
