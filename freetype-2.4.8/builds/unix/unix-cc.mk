...
#
CPPFLAGS := -D__NDS__ -DARM9 -I/opt/devkitpro/portlibs/nds/include -I/opt/devkitpro/libnds/include
CFLAGS   := -c -Wall -march=armv5te -mtune=arm946e-s -O2 -ffunction-sections -fdata-sections -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_OPTION_USE_BZIP2 -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS := -L/opt/devkitpro/portlibs/nds/lib -L/opt/devkitpro/libnds/lib -lz -lbz2 -march=armv5te
